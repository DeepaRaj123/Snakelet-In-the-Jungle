...
function preload(){
  ...
  playerImg4 = loadAnimation('png/Run (1).png','png/Run (2).png','png/Run (3).png','png/Run (4).png');
...
themem = loadSound("sound/theme.mp3");
gameoverm = loadSound("sound/gameover.mp3");
...
function setup(){
  ...
  player.addAnimation("right",playerImg4);  
  player.scale =0.23;
...
function draw() {
  ...
  else if(gameState==="level1")
  {
    ...
    {
     // jumpm.play();
     player.changeAnimation("right",playerImg4);  
     player.x = player.x +4;
    }
